# sqlalchemy_expert_versioning.md
...
v1.0.1 | 2026-02-03 | Repository boundaries clarified
  ...
  • Revert command: git checkout v1.0.0 -- aidocs/sqlalchemy_expert_protocol.md
...
v1.0.0 | 2026-02-03 | New protocol foundation
  ...
  • Revert command: git rm --cached aidocs/sqlalchemy_expert_protocol.md aidocs/sqlalchemy_expert_versioning.md
